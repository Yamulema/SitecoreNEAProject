...
namespace Neambc.Neamb.Foundation.Analytics.Gtm
{
    public class GtmService : IGtmService {
        ...
        public GtmService(IHtmlProcessor htmlProcessor) {
        ...
        public string GetOnClickEvent(object @object)
        {
            ...
            return $"onclick = \"{_dataLayerFunction}({SerializeObject(@object)},this);\"";
        }
        public string GetParameterGtmEvent(object @object)
        {
            if (@object == null)
            {
                return string.Empty;
            }
            return $"{SerializeObject(@object)},this";
        }
