...
{
    public class SeiuAutoAndHomeInsurance : IPartner
    {
        private readonly IPartnerConfiguration _partnerConfiguration;

        public SeiuAutoAndHomeInsurance(IPartnerConfiguration partnerConfiguration)
        {
        ...
        {
            return _partnerConfiguration.Token;
        }
    }
}