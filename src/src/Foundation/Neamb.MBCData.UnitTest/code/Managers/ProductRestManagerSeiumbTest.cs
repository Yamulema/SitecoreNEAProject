...
{
    [TestFixture]
    public class ProductRestManagerSeiumbTest
    {
        #region Fields
        ...
        private IProductRestManagerSeiumb _sut;
        ...
        public void SetUp() {
            ...
            _sut = new ProductRestManagerSeiumb(_accessTokenServiceMock.Object, _configMock.Object,_productRestManagerBaseMock.Object);
        }
        ...
        public void GetEligibility_WhenReturnFalse() {
            ...
            //var result= _sut.GetEligibility(940);
