...
{
    [Service(typeof(IStoreSearchManager))]
    public class StoreSearchManager : IStoreSearchManager
    {
        private IGlobalConfigurationManager _globalConfigurationManager;

        public StoreSearchManager(IGlobalConfigurationManager globalConfigurationManager)
        {
        ...
        public (IEnumerable<StoreSearchResult> results, bool hasOneMorePage) GetStores(bool popularOffers, bool favoritesOnly,
            ...
            using (var context = index.CreateSearchContext())
            {
                try {
                    ...
                    excludeStoresPredicate = excludeStoresPredicate.And(x => x.NEAMBEnable == true); //disabled for NEAMB
