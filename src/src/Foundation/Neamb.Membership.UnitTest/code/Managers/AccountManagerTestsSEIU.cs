...
{
    [TestFixture]
    public class AccountManagerTestsSEIU
    {
        #region Fields
        ...
        public void UpdatePasswordWhenReturnOk()
        {
            ...
            var result = _sut.UpdatePassword("test", "test", "test", (int)Union.SEIU);
        ...
        public void ResetPasswordWhenReturnOk()
        {
            ...
            var result = _sut.ResetPassword("test", "test", "test", (int)Union.SEIU);
        ...
        public void UpdateUserStatusWhenReturnOk()
        {
            ...
            var result = _sut.UpdateUserStatus("test", (int)UserStatus.Default, (int)Union.SEIU);
