...
namespace Neambc.Neamb.Foundation.Cache.Managers
{
    ...
    public class RedisCacheNeambManager : ICacheManager
    {
        private readonly string _environment;
        private readonly IRedisCacheManagerBase _redisCacheManagerBase;

        public RedisCacheNeambManager(ICacheNeambConfigRepo cacheConfigRepo, IRedisCacheManagerBase redisCacheManagerBase)
        {
            _environment = cacheConfigRepo.CacheNeambConfiguration.EnvironmentCacheKey;
