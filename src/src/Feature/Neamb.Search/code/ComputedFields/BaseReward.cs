...
namespace Neambc.Neamb.Feature.Search.ComputedFields {
    ...
    [Obsolete]
    public class BaseReward : IComputedIndexField {
        public string FieldName { get; set; }
        public string ReturnType { get; set; }

        public BaseReward()
        {
            Log.Info("BaseReward - Constructor", this);
        }
        ...
        public object ComputeFieldValue(IIndexable indexable)
        {
            ...
            // Better solution would be to limit indexing to the corresponding database, web or master
            ...
            {
                var reward = item.Children.FirstOrDefault(x => x.Name.Equals(Templates.Store.Child.BaseChild));
